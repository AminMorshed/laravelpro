@component('admin.layouts.content', ['title' => 'Create role'])
        ...
        <div class="col-ld-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Role creation form</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" action="{{route('admin.roles.store')}}" method="post">
                    ...
                    <div class="card-body">
                        <div class="form-group form-group row">
                            ...
                            <input type="text" name="name" class="form-control form-control mb-3" id="inputEmail3"
                                   placeholder="Type of roles" value="{{old('name')}}">
                        </div>
                        <div class="form-group form-group row">
                            ...
                            <input type="text" name="label" class="form-control form-control mb-3" id="inputEmail3"
                                   placeholder="Description of roles" value="{{old('label')}}">
                        </div>
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-info">Register role</button>
